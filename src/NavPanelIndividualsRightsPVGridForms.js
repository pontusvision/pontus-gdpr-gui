...
class NavPanelIndividualsRightsPVGridForms extends PVGrid
{
  ...
  componentDidMount()
  {
    ...
    colSettings[2] = {
      id: "Object.Form.Metadata_Owner", name: "Owner", field: "Object.Form.Metadata_Owner", sortable: true
    };
    colSettings[3] = {
      id: "Object.Form.Metadata_Create_Date", name: "Create Date", field: "Object.Form.Metadata_Create_Date",
      sortable: true
    };
    // colSettings[3] = {id: "Object.Notification_Templates.Text", visible: false, name: "Text", field:
    // "Object.Notification_Templates.Text",   sortable: true};
  ...
  // + ".range(pg_from,pg_to).as('dataProcs')" + ".match(" + "    __.as('dataProcs').values('Object.Form.URL')
  // .as('Object.Form.URL')" + "  ,
  ...
  // __.as('dataProcs').id().as('event_id')" + "  )" + selectBody , bindings: { pg_from: from , pg_to: to ,
  // pg_orderCol: sortcolId , pg_orderDir: sortdir }   }; };  // onError = (err, fromPage, toPage) => // { //   //
  // ignore. // };
