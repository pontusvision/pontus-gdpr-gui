...
class NavPanelChildrenPVGrid extends PVGrid
{
  constructor(props)
  {
    super({...props, namespace: "NavPanelChildren", dataType:"Person.Natural",
  ...
  static getDefaultColSettings()
  {
    ...
    colSettings[0] = {id: "Person.Natural.Date_Of_Birth", name: "Date Of Birth", field: "#Person.Natural.Date_of_Birth", sortable: true};
