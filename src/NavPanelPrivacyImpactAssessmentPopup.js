...
class NavPanelPrivacyImpactAssessmentPopup extends PVGDPRScores
{
  ...
  constructor(props)
  {
    ...
    this.text = PontusComponent.t('NavPanelPrivacyImpactAssessmentPopup_text');

    this.title =  PontusComponent.t('NavPanelPrivacyImpactAssessmentPopup_title');
    this.icon = shareAlt;
    this.weight = 6;
  ...
  getSearchQuery = () =>
  {
    ...
    return {
      gremlin: PontusComponent.t('NavPanelPrivacyImpactAssessmentPopup_query')
      , bindings: {
        // pg_from: from
        // , pg_to: to
