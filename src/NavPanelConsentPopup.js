...
class NavPanelConsentPopup extends PVGDPRScores
{
  ...
  constructor(props)
  {
    ...
    this.text = PontusComponent.t("NavPanelConsentPopup_text");
    
    this.title = PontusComponent.t("NavPanelConsentPopup_title");
  ...
  getSearchQuery = () =>
  {
    ...
    return {
      gremlin: PontusComponent.t("NavPanelConsentPopup_query")
