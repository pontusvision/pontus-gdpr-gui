...
import {flowMerge} from 'react-icons-kit-allreact/typicons/flowMerge';
import {wpforms} from 'react-icons-kit-allreact/fa/wpforms'
import {telescope} from 'react-icons-kit-allreact/oct/telescope';
...
class ExtractPanel extends PontusComponent
{
  
  constructor(props)
  {
    super(props);
    this.state = {height: window.innerHeight - 50, selected: "FormIO"};
  }
