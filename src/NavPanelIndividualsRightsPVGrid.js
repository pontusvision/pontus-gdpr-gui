...
class NavPanelIndividualsRightsPVGrid extends PVGrid
{
  ...
  static getDefaultColSettings()
  {
    ...
    colSettings[0] = {
      id: "Object.Data_Procedures.Type", name: "Data Type", field: "Object.Data_Procedures.Type", sortable: true
    };
    colSettings[1] = {
      id: "Object.Data_Procedures.Property", name: "Property", field: "Object.Data_Procedures.Property", sortable: true
    };
    colSettings[2] = {
      id: "Object.Data_Procedures.Delete_URL", name: "Delete Link", field: "Object.Data_Procedures.Delete_URL",
      sortable: true
    };
    colSettings[3] = {
      id: "Object.Data_Procedures.Delete_Mechanism", name: "Delete Mechanism",
      field: "Object.Data_Procedures.Delete_Mechanism", sortable: true
    };
    colSettings[4] = {
      id: "Object.Data_Procedures.Update_URL", name: "Update Link", field: "Object.Data_Procedures.Update_URL",
      sortable: true
    };
    colSettings[5] = {
      id: "Object.Data_Procedures.Update_Mechanism", name: "Update Mechanism",
      field: "Object.Data_Procedures.Update_Mechanism", sortable: true
    };
  ...
  //     ".order().by(pg_orderCol == null ? 'Object.Data_Procedures.Type' :pg_orderCol.toString() ,pg_orderDir == (1)?
  // incr: decr)" + ".range(pg_from,pg_to).as('dataProcs')" + ".match(" + "
